...
A. See [Optware replacement - 1700+ packages (arm & x86) - Synology Forum](https://forum.synology.com/enu/viewtopic.php?t=95346)
B. Use *Easy Bootstrap Installer* in Package Center. opkg will be avialable for root only.
